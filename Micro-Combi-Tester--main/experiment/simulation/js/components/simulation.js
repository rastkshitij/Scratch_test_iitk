                        ...
                        <div class="simulation-buttons">
                            <button class="btn btn-primary" id="moveButton">
                                ${this.isSimulating ? 'Pause' : 'Start'}
                                                        ...
                                                        <button class="btn btn-primary" id="calibrationButton">Calibration</button>
                                                        <button  class="btn btn-primary" id="moveToMidButton">Position</button> 
                                                         <button  class="btn btn-primary" id="moveUpButton">Microscope</button>
                                                          <button  class="btn btn-primary" id="moveRightButton">Position 2</button>
